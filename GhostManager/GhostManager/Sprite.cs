    ...
    public class Sprite : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public virtual void Draw(SpriteBatch sb)
        {
            sb.Draw(spriteTexture,
                ...
                SpriteEffects,
                0);
            //Helps put the object in the center of the screen
            //sb.Draw(spriteTexture, OriginScreenCenter, null, Color.White, MathHelper.ToRadians(Rotate), this.OriginSprite, 1f, SpriteEffects, 0f);
